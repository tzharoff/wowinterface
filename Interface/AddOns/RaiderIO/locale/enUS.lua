...
L.RAID_ICC = "Icecrown Citadel"local ns = select(2, ...) ---@class ns @The addon namespace.
...
BINDING_NAME_RAIDERIO_REPLAYUI_TIMING_DUNGEON = L.BINDING_NAME_RAIDERIO_REPLAYUI_TIMING_DUNGEONlocal ns = select(2, ...) ---@class ns @The addon namespace.
